 ...
 *
 * Normaliza o array de livros (hoje em window.LIVRO_BOOKS) para uma API
 * estável, preparando a migração futura para data/books.json via fetch.
 * É SEGURO incluir mesmo que LIVRO_BOOKS ainda não esteja definido:
 * as funções simplesmente retornam vazio até os dados carregarem.
 */
(function (global) {
  'use strict';

  var SOURCE = global.LIVRO_BOOKS || [];
